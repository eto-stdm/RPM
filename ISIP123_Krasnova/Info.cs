...
namespace ISIP123_Krasnova
{
    internal class Info
    {
        ...
        //Slime slime1 = new Slime("Огненный слайм", 20, 2, 1);
        //Slime slime2 = new Slime("Ледяной слайм", 15, 3, 3);
        //Slime slime3 = new Slime("Водный слайм", 17, 1, 2);
