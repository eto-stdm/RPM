...
else
{
    do
    {
        ...
        switch (menu)
        {
            case "1": statistika(text); break;
            case "2": text_new(text); break;
            case "3": text_continue(text); break;
            case "4": break;
            case "5": break;
            case "0": break;
            default: continue;
...
{ 
    ...
    Console.WriteLine($"Общее количество слов: {t_words}");
}
void shortest_word(string s) // кратчайшее слово
{
    ...
    Console.WriteLine($"Самое короткое слово: {res}");
}
void count_sentence(string s) // подсчёт предложений
{
    int t_sentences = 0;
    foreach (char c in s)
    {
    ...
    Console.WriteLine($"Общее количество слов: {t_sentences}");
}
...
void text_new(string s)
{
    Console.WriteLine("Введите текст:");
    s = Console.ReadLine();

}
void text_continue(string s)
{
    ...
    switch (m1)
    {
        case "1": Console.WriteLine(s); break;
        case "2": s += Console.ReadLine(); break;
